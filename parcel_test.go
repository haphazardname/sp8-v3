...
func TestAddGetDelete(t *testing.T) {
	...
	assert.Equal(t, parcel.CreatedAt, g.CreatedAt)
...
func TestSetAddress(t *testing.T) {
	...
	ch, err := store.Get(i)
	require.NoError(t, err)
	require.Equal(t, ch.Address, newAddress)
...
func TestSetStatus(t *testing.T) {
	...
	err = store.SetStatus(i, ParcelStatusDelivered)
	require.NoError(t, err)
	...
	ch, err := store.Get(i)
	require.NoError(t, err)
	require.Equal(t, ch.Status, ParcelStatusDelivered)
}
